...
char * MailHeader(const char* from, const char* to, const char* subject, const char* mime_type, const char* charset) {
    ...
    time_t now;
    time(&now);
    char *app_brand = "This is a Test Application";
        ...
        if ((ctx = SSL_CTX_new(method)) == NULL) {
            ...
            if (connceted_fd != 0) {
                ...
                if (SSL_connect(ssl) != 1) {
                    ...
                    char *header = MailHeader(MAIL_HEADER_FROM, MAIL_HEADER_TO, "Its a test Mail.", "text/plain", "US-ASCII");
                    ...
                    char _cmd8[1000];
                    strcpy(_cmd8, "Hello!!! This is a sample mail sent using c++.");
